...
import com.example.ve16i04001.databinding.IniciarJuegoBinding
import com.example.ve16i04001.databinding.ItemUsuarioBinding

class UsuarioAdapter(private var lstUsuarios: MutableList<UsuarioEntity>
//    , private var context: Context
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        with(holder) {
            ...
            binding.tvintentos.text = item.getIntentos()
